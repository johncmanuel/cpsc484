...
>
test inverse
<'a_CofactorTranspose * 0.100000', <col0,   0   0   0   0><col1,   0   0   1   0><col2,   0   0   0   0>> OR by rows...
0.2 -0.2 0.2 
0.2 0.3 -0.3 
 -0   1   0 
>
<'b_CofactorTranspose * 1.000000', <col0, -24  18   5   0><col1,  20 -15  -4   0><col2,  -5   4   1   0>> OR by rows...
-24  20  -5 
 18 -15   4 
  5  -4   1 
>
test a * ainv, b * binv
<'a*a_CofactorTranspose * 0.100000', <col0,   1   0   0   0><col1,   0   1   0   0><col2,   0   0   1   0>> OR by rows...
  1   0   0 
  0   1   0 
  0   0   1 
>
<'b*b_CofactorTranspose * 1.000000', <col0,   1   0   0   0><col1,   0   1   0   0><col2,   0   0   1   0>> OR by rows...
  1   0   0 
  0   1   0 
  0   0   1 
>
...
test 3.0 * a == a * 3.0
test a + 3.0 - 3.0 == a
<'a + 3.000000', <col0,   6   3   5   0><col1,   5   3   1   0><col2,   3   4   4   0>> OR by rows...
  6   5   3 
  3   3   4 
  5   1   4 
>
<'a + -3.000000', <col0,   0  -3  -1   0><col1,  -1  -3  -5   0><col2,  -3  -2  -2   0>> OR by rows...
  0  -1  -3 
 -3  -3  -2 
 -1  -5  -2 
>
<'a + 3.000000 + -3.000000', <col0,   3   0   2   0><col1,   2   0  -2   0><col2,   0   1   1   0>> OR by rows...
  3   2   0 
  0   0   1 
  2  -2   1 
>
test a * 3.0 / 3.0 == a
<'a * 3.000000', <col0,   9   0   6   0><col1,   6   0  -6   0><col2,   0   3   3   0>> OR by rows...
  9   6   0 
  0   0   3 
  6  -6   3 
>
<'a * 0.333333', <col0,   1   0   0   0><col1,   0   0   0   0><col2,   0   0   0   0>> OR by rows...
  1 0.667   0 
  0   0 0.333 
0.667 -0.667 0.333 
>
